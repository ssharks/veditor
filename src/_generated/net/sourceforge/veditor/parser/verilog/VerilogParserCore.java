...
begin(STATEMENT);
  ...
  final public void portDecl() throws ParseException {Token direction;
        String modifier;
        String range;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INPUT:{
...
variableAssignment(name);
  ...
  final public void primitiveInstance() throws ParseException {String prim;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PRIM_1IN_XOUT:{
...
prim = token.image;
  ...
  final public void moduleInstance() throws ParseException {Identifier module, inst;
        Token iend ;
    module = identifier();
begin(STATEMENT);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
endOutlineElement(iend, inst.image, "instance#"+module.image);
  ...
  final public void portConnect(String module) throws ParseException {int count = 0;
  ...
  final public int portConnectSingle(String module, int count) throws ParseException {Identifier port;
        Expression arg = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DOT:{
      jj_consume_token(DOT);
